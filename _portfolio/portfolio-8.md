...
* Analyzed the effect of different feature engineering and dimensionality adjustment techniques (performed on the [UCI's mushroom dataset](https://archive.ics.uci.edu/dataset/73/mushroom)) on the performance of various Machine Learning models.
