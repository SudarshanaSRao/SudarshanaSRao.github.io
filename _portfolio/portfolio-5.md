...
* Performed comprehensive feature analysis and visualization using **Tableau** to highlight the impact of feature engineering techniques such as Pearson Correlation Coefficient and dimensionality reduction methods like PCA and Univariate Feature Selection. Developed interactive dashboards to illustrate feature distributions, correlations, and their contributions to model performance, enhancing interpretability and data-driven decision-making.
