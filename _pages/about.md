...
<div style="display: flex; flex-direction: column; align-items: center; margin-top: 100px;">
  ...
  <span style="font-family: 'Brush Script MT', cursive; font-size: 30px; color: #9370DB; display: inline;">-</span> 
  <span style="font-family: 'Brush Script MT', cursive; font-size: 26px; color: #9370DB; display: inline;">SJ</span>
</div>
